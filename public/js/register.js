...
class RegisterForm {
    constructor() {
        ...
        this.validators = {
            name: FormUtils.validateName,
            email: FormUtils.validateEmail,
            password: FormUtils.validatePassword,
            confirmPassword: FormUtils.validateConfirmPassword
        };
    ...
    handleForgotPassword(e) {
        ...
        FormUtils.showNotification('Liên kết đặt lại mật khẩu sẽ được gửi đến email của bạn', 'info', this.form);
    }
    ...
    showLoginError(message) {
        FormUtils.showNotification(message || 'Đăng nhập không thành công. Vui lòng thử lại.', 'error', this.form);
